function(download_spinnaker FLIR_LIB_VAR FLIR_INCLUDE_DIR_VAR)
  ...
  set(FLIR_DIR ${CMAKE_CURRENT_BINARY_DIR})
  ...
  set(${FLIR_LIB_VAR} "${FLIR_DIR}/usr/lib/libSpinnaker.so" PARENT_SCOPE)
  set(${FLIR_INCLUDE_DIR_VAR} "${FLIR_DIR}/usr/include/spinnaker" PARENT_SCOPE)
endfunction()
